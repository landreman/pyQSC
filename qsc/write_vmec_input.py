...
def write_vmec_input(self, rVMEC, filename, vmec_template_filename):
    """
    Output a near-axis boundary to a VMEC input file
    """
    if vmec_template_filename==[]:
        delt=0.9
        niter=2500
        nstep=200
        tcon0=2.
    ...
    if vmec_template_filename!=[]:    File_object.write("! Based on template file ",vmec_template_filename+'\n')
